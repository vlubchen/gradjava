...
<body>
<script src="resources/js/gradjava.common.js" defer></script>
<script src="resources/js/gradjava.users.js" defer></script>
    ...
    <div class="container">
        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${requestScope.users}" var="user">
                <jsp:useBean id="user" type="ru.vlubchen.gradjava.model.User"/>
                <tr data-user-enabled="${user.enabled}">
                    ...
                    <td><fmt:formatDate value="${user.registered}" pattern="dd-MMMM-yyyy HH:mm:ss"/></td>
